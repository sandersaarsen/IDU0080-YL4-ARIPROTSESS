...
public class Kuller_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Sander/Documents/Kool/Magister/2.Semester/IDU0080/4töö-workplace/BP/WebContent/kuller.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Kuller_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Sander/Documents/Kool/Magister/2.Semester/IDU0080/4töö-workplace/BP/WebContent/kuller.wsdl");
        }
        WSDL_LOCATION = url;
    }
