...
public class Transport_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Sander/Documents/Kool/Magister/2.Semester/IDU0080/4töö-workplace/BPTransport/WebContent/transport.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Transport_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Sander/Documents/Kool/Magister/2.Semester/IDU0080/4töö-workplace/BPTransport/WebContent/transport.wsdl");
        }
        WSDL_LOCATION = url;
    }
