...
public class OrderShipment {
	...
	public OrderShipment(XMLGregorianCalendar approxDeliveryDate,
			String courierName, int order, int orderShipment, String ryhmName,
			double shippingPrice, String trackingNumber) {
		super();
